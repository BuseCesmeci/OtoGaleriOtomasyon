            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="satSube" id="satSubetext" runat="server"><b>ARACIN BULUNDUĞU ŞUBE</b></label>
                            <asp:TextBox class="form-control" runat="server" ID="satSube"></asp:TextBox>
                        </div>
                        <div class="form-group">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <%--                        <div class="form-group">
                            <label for="txtmaliyet" id="txt2Maliyet" runat="server"><b>Maliyet</b></label>
                            <asp:TextBox runat="server" ID="txtmaliyet"></asp:TextBox>
                        </div>--%>
                        <div class="mt-2 py-3">
                    ...
                    <div class="col-6">
                        <asp:GridView runat="server" ID="GdMaliyet" AutoGenerateColumns="false" CssClass="table bg-white table-bordered">
                            <Columns>
                                <asp:BoundField HeaderText="Maliyet No" DataField="maliyetID"/>
                                <asp:BoundField HeaderText="Alış Fiyatı" DataField="subeadi" />
        ...
        <section class="py-5 gray">
            <div class="container">
                <div class="row">
                    ...
                    <div class="py-3">
                        <h5>ÇALIŞANLAR</h5>
                        <asp:GridView runat="Server" ID="GdCalisanlar" AutoGenerateColumns="False" CssClass="table table-bordered table-light">
                            <Columns>
