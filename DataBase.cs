...
namespace otogalerisistemi
{
    public class DataBase
    {
        ...
        public static bool SuperuserLogin(string kullaniciadi, string sifre,string subeadi)
        {
            ...
            SqlCommand command = new SqlCommand("select kullaniciadi,sifre,subeadi from admin where yetkiID=@yetkiID,subeadi=@subeadi", connection);
            command.Parameters.AddWithValue("@kullaniciadi", kullaniciadi);
            command.Parameters.AddWithValue("@sifre", sifre);
            command.Parameters.AddWithValue("@yetkiID", "1");
        ...
        public static bool MudurLogin(string kullaniciadi, string sifre, string subeadi)
        {
            
            SqlCommand command = new SqlCommand("select kullaniciadi,sifre from admin where yetkiID=@yetkiID'", connection);
            command.Parameters.AddWithValue("@kullaniciadi", kullaniciadi);
            command.Parameters.AddWithValue("@sifre", sifre);
            command.Parameters.AddWithValue("@subeadi", subeadi);
            command.Parameters.AddWithValue("@yetkiID", "2");
            connection.Open();
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            DataSet sonuc = new DataSet();
            connection.Open();
        ...
        public static bool DanismanLogin(string kullaniciadi, string sifre, string subeadi)
        {           
            ...
            command.Parameters.AddWithValue("@sifre", sifre);
            command.Parameters.AddWithValue("@subeadi", subeadi);
            command.Parameters.AddWithValue("@yetkiID", "3");
            connection.Open();
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            DataSet sonuc = new DataSet();
            connection.Open();
        ...
        public static bool Login(int yetkiID,string kullaniciadi)
        {
            string sql = "select * from admin where kullaniciadi=@kullaniciadi and yetkiID=@yetkiID ";
