...
namespace otogalerisistemi
{
    public partial class mudur : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand("select DISTINCT SUM(maliyet.alisfiyati+maliyet.vergi+maliyet.bakim) as maliyet from maliyet inner join araclar on araclar.aracno=maliyet.aracno where subeadi='" + subeadi + "'", connection);
            connection.Open();
